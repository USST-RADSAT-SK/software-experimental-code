...
int testPadBufferHelper(uint8_t* buf1){
	// Subtract 1 to get rid of null byte
	int bufSize = sizeof(buf1) / sizeof(buf1[0]) - 1;
...
int testPadBuffer(){
	...
	testPadBufferHelper("asdfasdfasdf");
	testPadBufferHelper("asdfasdfasdfasdf");
	testPadBufferHelper("T");
...
int testEncrypt(){
	...
	testEncryptHelper("");
	testEncryptHelper("1");
	testEncryptHelper("");
	testEncryptHelper("1234123412341234");
